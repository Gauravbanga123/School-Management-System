...
<li class="nav-item has-treeview">
                ...
                <li class="nav-item">
                <a href="<?=$site_url?>admin/user_account.php? user=counsellor" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?=$site_url?>admin/user_account.php? user=parent" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Parents</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=$site_url?>admin/user_account.php? user=librarian" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Librarian</p>
                </a>
              </li>
