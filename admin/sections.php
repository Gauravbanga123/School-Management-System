...
if(isset($_POST['submit'])){
    $title=$_POST['title'];
    mysqli_query($db_conn,"INSERT INTO sections (title) VALUE ('.$title.')") or die('bvvhhv');
} ?>
     ...
     <h3 class="card-title">
       Sections
        ...
        <div class="card-tools">
          <a href="?action=add-new" class="badge badge-success"><i class="fa fa-plus mr-1"> </i>Add New</a>
        </div>
     <div class="card-body">
